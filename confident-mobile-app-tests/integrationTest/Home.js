...
var results1 = {
    ...
    "queryResult": {
        "queryText": "¿Qué te gustaría saber sobre sexo?",
        "action": "1.1.2",
        "parameters": {},
        ...
        "fulfillmentMessages": [
            {
                "text": {
                    "text": [
                        "A partir de ahora, solo presiona una de las opciones que se te presentarán abajo de cada pregunta. ¿Qué tema quieres hablar? 🤓"
                    ]
                }
            }
        ],
...
var results2 = {
    "responseId": "8ad22784-092d-4ac8-a182-f883ed10d66b-9df18b51",
    "queryResult": {
        "queryText": "¿Cómo te ves en 2 años?",
        "action": "3.1.1",
        "parameters": {},
        "allRequiredParamsPresent": true,
        "fulfillmentText": "¿Cómo te ves en 2 años?",
        "fulfillmentMessages": [
            {
                "text": {
                    "text": [
...
class Home extends Component {
    ...
    state = {
        ...
        messages: [
            ...
            {
                _id: 2,
                text: 'Toca "Confident ✌️" para verme 🙃',
                createdAt: newDate,
                user: BOT_USER
            },
            {
                _id: 3,
                text: '¿De qué se trata la app? 👉 en 🏠. Contactos de ayuda 👉 en 📞',
                createdAt: newDate,
                user: BOT_USER
            },
            {
